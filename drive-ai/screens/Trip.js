...
export default class Trip extends Component {
  static navigationOptions = ({ navigation }) => {
    ...
    return {
      headerTitle: <Text style={theme.fonts.header}>Viaje actual</Text>,
      headerLeft: null,
      headerRight: (
        <TouchableOpacity
        ...
        >
          <Text
            ...
            transform="uppercase"
          >
            {showMap ? "quitar el mapa" : "enseñar el mapa"}
          </Text>
        </TouchableOpacity>
      )
    };
      ...
      <TouchableOpacity activeOpacity={0.8} onPress={() => {}}>
        <Card shadow style={styles.drivingStatus}>
          ...
          <Text
            ...
            accent={drive.status === "mal"}
            tertiary={drive.status === "justo"}
            primary={drive.status === "bien"}
            height={22}
          >
            {drive.status}
          </Text>
