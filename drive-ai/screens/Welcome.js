...
// alternativa para expo LinearGradient
...
export default class Welcome extends Component {
  static navigationOptions = {
    headerTitle: <Text style={theme.fonts.header}>Bienvenido</Text>,
    headerRight: (
      <TouchableOpacity>
        <Block flex={false}>
          <Image
        ...
        <Card shadow style={{ paddingVertical: theme.sizes.padding }}>
          ...
          <Block>
            <Block center>
              ...
              <Text spacing={0.7}>Recompensas mensuales totales</Text>
            </Block>
